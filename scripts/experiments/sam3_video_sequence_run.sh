#!/bin/bash
#SBATCH --job-name=iDisc-sam3-video-seq
#SBATCH --account=3dv
#SBATCH --gpus=1
#SBATCH --constraint=5060ti
#SBATCH --time=14:00:00
#SBATCH --mem=48G
#SBATCH --output=logs/sam3_video_seq_%j.out
#SBATCH --error=logs/sam3_video_seq_%j.err
...
python -u scripts/run_with_hydra.py experiment=sam3_video_sequence
