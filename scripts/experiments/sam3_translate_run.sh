#!/bin/bash
#SBATCH --job-name=iDisc-sam3-translate
#SBATCH --account=3dv
#SBATCH --gpus=1
#SBATCH --time=04:00:00
#SBATCH --mem=48G
#SBATCH --output=logs/sam3_translate_%j.out
#SBATCH --error=logs/sam3_translate_%j.err
...
python -u scripts/run_with_hydra.py experiment=sam3_translate
