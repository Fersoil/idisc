#!/bin/bash
#SBATCH --job-name=iDisc-sam3-pure
#SBATCH --account=3dv
#SBATCH --gpus=1
#SBATCH --time=06:00:00
#SBATCH --mem=48G
#SBATCH --output=logs/sam3_pure_%j.out
#SBATCH --error=logs/sam3_pure_%j.err
...
python -u scripts/run_with_hydra.py experiment=sam3_pure
